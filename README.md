...
| `my-code-review` | コードの品質・可読性・保守性・セキュリティを評価し改善提案 | 「コードをレビューして」「このPRを確認して」 |
...
| `tdd` | Kent Beck の Red → Green → Refactor で開発を駆動。テスト先行を強制し、テストリスト管理・三角測量・リファクタ規律を適用 | 「TDDで進めて」「/tdd」 |
